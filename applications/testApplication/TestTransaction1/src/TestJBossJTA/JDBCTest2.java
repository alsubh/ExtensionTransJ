...
public class JDBCTest2
{
	...
	try
	    {		
		String url= "jdbc:sqlserver://localhost:1433;databaseName=Bank1;user=anas;password=tedi;integratedSecurity=true";
		...
		try
			...
			com.arjuna.ats.jta.UserTransaction.userTransaction().commit();//commit(true);
		    }
		catch (Exception ex)
		    {
			ex.printStackTrace();
