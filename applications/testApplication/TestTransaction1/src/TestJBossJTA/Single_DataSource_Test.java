...
public class Single_DataSource_Test 
{ 
	public static void main (String [] args) 
	{ 
		Single_DataSource_Test mdt = new Single_DataSource_Test(); 
		try
		{ 
			mdt.test1 (); 
		}
		...
		{ 
			...
			Logger.getLogger (Single_DataSource_Test.class.getName ()).log (Level.SEVERE, null, ex); 
		} 
	} 
		...
		{ 
			...
			try 
				...
				{ 
					...
					e.printStackTrace (); 
			 		Logger.getLogger (Single_DataSource_Test.class.getName ()).log (Level.SEVERE, null, e); 
			 	}
				finally
				{ 
					try { 
					...
					{ 
						Logger.getLogger (Single_DataSource_Test.class.getName ()).log(Level.SEVERE, null, sqex); 
					} 
				}
		} catch (XAException e) {
