...
public class ApplicationClient {
	...
	public void t1(int numberOfGoos, String nameOfRawWidget,
			String codeOfRawWidget, String nameOfRoughWidget,
			String codeOfRoughWidget, String nameOfPolishedWidget,
			String codeOfPolishedWidget) throws SecurityException,
		...
		System.out
				.println("Number of Goo that required for starting production: "
						+ goos.size());
		...
		polished = t1.getPolishedWidget(nameOfPolishedWidget,
				codeOfPolishedWidget, rough);

		// t1.putInWidgetPile(polished);
	}

	public void t2(String gadgetName, String gadgetCode, String tag,
			int numberOfRequiredWidgets) {
