...
import umjdt.concepts.*;
   ...
   * transTransTransTransaction. Essentially this is a stack of transTransTransTransactions.*/
	...
	public class BKThreadTransaction
	    {
	        public static Transaction currentTransaction()
	        {
	        	BKThreadTransaction.setup();
	       ...
	       public static void purgeTransaction (Transaction act)
	               throws NoSuchElementException
	       {
	           BKThreadTransaction.purgeTransaction(act, Thread.currentThread(), true);
	       }
	   
	       public static void purgeTransaction (Transaction act, Thread t)
	               throws NoSuchElementException
	       {
	           BKThreadTransaction.purgeTransaction(act, t, true);
	       }
	   
	       public static void purgeTransaction (Transaction act, Thread t, boolean unregister)
	               throws NoSuchElementException
	       {
